...
const { getCliente, Getclientes, postCliente, putCliente, deleteCliente,GetclienteCheckOut,GetOrdenDetalle,GetOrden } = require('../controllers/cliente')
...
router.get('/order', GetOrden )
router.get('/order/:id', GetOrdenDetalle)
